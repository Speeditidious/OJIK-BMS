...
pub struct UpdateAnnouncement {
    ...
    pub body_markdown_en: Option<String>,
    pub body_markdown_ja: Option<String>,
    ...
    fn preserves_supports_auto_install_from_server_response() {
        let raw = r#"{
            ...
            "announcement": {
                ...
                "body_markdown_en": "Release notes in English",
                "body_markdown_ja": "Release notes in Japanese",
